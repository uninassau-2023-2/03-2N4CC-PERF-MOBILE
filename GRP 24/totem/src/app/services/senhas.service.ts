...
export class SenhasService {
  ...
  public lastsenha: string = '';
  public guiche01: number = 1;
  public guiche02: number = 2;
  public guiche03: number = 3;
  public guiches: string = '';
  ...
  public numeroChamado: string | null = null;
  ...
  novaSenha(tipoSenha: string = '') {
    ...
    this.numeroChamado = `A${this.senhasTotal}`;
